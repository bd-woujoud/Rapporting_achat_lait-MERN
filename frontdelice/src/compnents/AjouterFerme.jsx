...
import { Ajoutferme, selectregistererror } from '../features/Ferme/FermeSlice';
import { classes, gouvernerats, natures, regions, souCategories, zones } from '../mokh/donnees';
const { Option } = Select;


function AjouterFerme(props) {
    ...
    const [achetteur, setAchetteur] = useState(allachetteur[0])
    ...
    const Ajouter = (e) => {
        ...
        dispatch(Ajoutferme(data))
        // Swal.fire({
        //     title: "Success",
        //     text: "ferme ajouté avec succées",
        //     icon: "success",
    ...
    return (
        ...
        <div >
            <img src={fermeaj} alt="imgcentre" onClick={showModal} style={{ height: "70px", marginTop: "10px", marginLeft: "10px" }}></img>

            <Modal style={{ marginTop: '0px' }} footer={null} title="Ajouter un nouveau ferme" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} >
